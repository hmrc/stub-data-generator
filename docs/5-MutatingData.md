...
store: hmrc.smartstub.PersistentGen[String,List[String]] = org.scalacheck.Gen$$anon$3@164efbfa
...
res3: hmrc.smartstub.PersistentGen[String,List[String]] = org.scalacheck.Gen$$anon$3@164efbfa

scala> store.get("NI 31 00 00 A")
res4: Option[List[String]] = Some(List(15C, Pettsgrove Avenue, Lerwick, ZE75 8OI))

scala> store -= "NI 31 00 00 A"
res5: store.type = org.scalacheck.Gen$$anon$3@164efbfa
